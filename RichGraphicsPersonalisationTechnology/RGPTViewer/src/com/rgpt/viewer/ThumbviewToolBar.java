...
public class ThumbviewToolBar extends JDialog {
	...
	Map<Integer, ImageHolder> m_ImageAssets;
	...
	public ThumbviewToolBar(Map<Integer, ImageHolder> imageAssets) {
		this(null, imageAssets);
	}

	public ThumbviewToolBar(SelectedImageHandler imgHdlr,
			Map<Integer, ImageHolder> imageAssets) {
	...
	public void setImageSelectionHandler(SelectedImageHandler imgHdlr) {
		m_SelectedImageHandler = imgHdlr;
	}
	...
	// Object Creates thumbnail versions of the target image files.
