...
public class RotateFilter extends ImageFilter {
    ...
    public void setColorModel(ColorModel model) {
        //System.out.println("In setColorModel");
    ...
    public void setPixels(int x, int y, int w, int h, ColorModel model,
        ...
        //System.out.println("In setPixels with int");
        int srcoff = off;
        int dstoff = y * srcW + x;
    ...
    public void setPixels(int x, int y, int w, int h, ColorModel model,
        ...
        //System.out.println("In setPixels with byte");
        int srcoff = off;
        int dstoff = y * srcW + x;
        if (model == defaultRGB) {
            for (int yc = 0; yc < h; yc++) {
    ...
    public void imageComplete(int status) {
        //System.out.println("In imageComplete with status: " + status);
