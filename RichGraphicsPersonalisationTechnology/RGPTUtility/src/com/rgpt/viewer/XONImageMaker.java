...
public class XONImageMaker extends JFrame implements RGPTActionListener {
	...
	private JPanel createCenterPane() throws Exception {
		...
		int panelHt = AppletParameters.getIntVal("NorthPanelHeight");
		int panelWt = m_ContentPaneSize.width - m_WestPanelWidth
				- AppletParameters.getIntVal("ImageMakerEastPanelWidth");
	...
	private JPanel createEastPanel() {
		...
		int sthEastHt = AppletParameters
				.getIntVal("ImageMakerSouthEastPanelHeight");
		int eastPanelWt = AppletParameters
				.getIntVal("ImageMakerEastPanelWidth");
		...
		JPanel zoomPanel = RGPTUIUtil.createPanel(m_ZoomViewPane, true,
				RGPTUIUtil.LOWERED_BORDER);
		int zoomlHt = AppletParameters.getIntVal("ImageMakerZoomPanelHeight");
	...
	private JPanel createWestPanel() {
		...
		westPanel.add(emptyPanel);
		int panelHt = AppletParameters.getIntVal("ImageMakerWestPanelHeight");
	...
	private void createImagingPanel(JPanel westPanel, boolean isImageSelPanel) {
		...
		int panelHt = AppletParameters
				.getIntVal("ImageMakerImagingPanelHeight");
	...
	private JPanel createFileActionPanel() {
		...
		int filePanelHt = AppletParameters
				.getIntVal("IMAppsFileActionPanelHeight");
	...
	public void repaintImagePreviewPane(Graphics g) {
		...
		// RGPTLogger.logToConsole("Panel Size: "+panelSize);
		int panelWt = AppletParameters.getIntVal("ImageMakerEastPanelWidth");
