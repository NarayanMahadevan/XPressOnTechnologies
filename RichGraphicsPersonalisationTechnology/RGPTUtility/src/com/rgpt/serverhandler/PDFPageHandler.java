...
public interface PDFPageHandler 
{
   ...
   // This method is invoked to allign VDP field to Left, Center or Right WRT BBox
   public void allignWRTBBox(String allign);

   // This method is invoked to allign VDP field to Left, Center or Right WRT BBox
   public void allignWRTPage(String allign);

   // This method is invoked to scale PDF Page along Height, Width and coplete Page
