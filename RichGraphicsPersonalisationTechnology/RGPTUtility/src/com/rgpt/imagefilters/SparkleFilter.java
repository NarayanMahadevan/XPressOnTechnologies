...
public class SparkleFilter extends PointFilter {
	...
	private float percCentreX = 0.5F, percCentreY = 0.5F;
   ...
   public void setPercCentreX(float x) {
      percCentreX = x;
   }
   
   public void setPercCentreY(float y) {
      percCentreY = y;
   }
	...
	public void setDimensions(int width, int height) {
		this.width = width;
		this.height = height;
		centreX = (int)(width*percCentreX);
		centreY = (int)(height*percCentreY);
      ...
      RGPTLogger.logToFile("wt: "+this.width+" ht: "+this.height+" cntx: "+centreX+" cnty: "+centreY); 
   }
